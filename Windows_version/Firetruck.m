...
%   - 2 = Variable to Restricted range
%   - 3 = Restricted Range to Constant  
% - Condition
...
keys.downKey = KbName('down');
keys.upKey = KbName('up');
...
if trial.cond_order == 1
    ...
    elseif trial.spread == 2
        ...
        box.minspeed = [1 round(box.maxspeed/4)];
...
elseif trial.cond_order == 2
    ...
    elseif trial.spread == 2
        ...
        box.minspeed = [round(box.maxspeed/4) 1];
